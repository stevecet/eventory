...
export default function EventDiscovery({
  ...
  const allEvents: Event[] = [
    ...
    },
    {
      ...
      description:
        "Join us for a relaxing outdoor yoga session in the park. All levels welcome. Bring your own mat.",
    ...
    },
    {
      ...
      description:
        "Exclusive networking event for business professionals. Connect with industry leaders over dinner.",
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        updateFilter("isFree", checked ? true : null)
                      }
                    />
